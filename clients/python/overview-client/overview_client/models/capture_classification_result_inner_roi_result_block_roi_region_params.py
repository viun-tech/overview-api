...
class CaptureClassificationResultInnerRoiResultBlockRoiRegionParams(BaseModel):
    """
    CaptureClassificationResultInnerRoiResultBlockRoiRegionParams
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of the ROI region")
    bbox: Optional[List[Union[StrictFloat, StrictInt]]] = Field(default=None, description="Bounding box coordinates [x, y, width, height]")
    angle: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["name", "bbox", "angle"]
