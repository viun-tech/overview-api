...
class CaptureClassificationResultInnerRoiResult(BaseModel):
    """
    CaptureClassificationResultInnerRoiResult
    """ # noqa: E501
    block_roi_region_params: Optional[CaptureClassificationResultInnerRoiResultBlockRoiRegionParams] = None
    __properties: ClassVar[List[str]] = ["block_roi_region_params"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of block_roi_region_params
        if self.block_roi_region_params:
            _dict['block_roi_region_params'] = self.block_roi_region_params.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "block_roi_region_params": CaptureClassificationResultInnerRoiResultBlockRoiRegionParams.from_dict(obj["block_roi_region_params"]) if obj.get("block_roi_region_params") is not None else None
        })
        return _obj
