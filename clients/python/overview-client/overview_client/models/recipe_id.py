...
class RecipeId(BaseModel):
    ...
    RecipeId
    """ # noqa: E501
    id: Optional[Annotated[int, Field(le=65535, strict=True, ge=1)]] = Field(default=None, description="ID of the recipe available (Not the PLC ID, [more info](https://docs.overview.ai/docs/recipe-change-using-http))")
