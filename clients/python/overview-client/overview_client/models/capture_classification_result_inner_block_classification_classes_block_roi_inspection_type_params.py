...
class CaptureClassificationResultInnerBlockClassificationClassesBlockRoiInspectionTypeParams(BaseModel):
    """
    CaptureClassificationResultInnerBlockClassificationClassesBlockRoiInspectionTypeParams
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of the inspection type")
